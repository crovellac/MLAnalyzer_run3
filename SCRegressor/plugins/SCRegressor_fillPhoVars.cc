...
void SCRegressor::fillPhoVars ( const edm::Event& iEvent, const edm::EventSetup& iSetup )
{
  ...
  //EcalClusterLazyTools clusterTools ( iEvent, ESRecHitCollectionT_, EBRecHitCollectionT_, EERecHitCollectionT_);
  //EcalClusterLazyToolsT<EcalClusterToolsT<false>> clusterTools(iEvent);
  EcalClusterLazyToolsT<EcalClusterToolsT<false>> clusterTools(
    iEvent, iSetup, 
    EBRecHitCollectionT_, EERecHitCollectionT_, ESRecHitCollectionT_
  );
