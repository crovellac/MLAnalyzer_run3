...
void SCRegressor::branchesPFCandsAtEBEE ( TTree* tree, edm::Service<TFileService> &fs ) {
...
void SCRegressor::fillPFCandsAtEBEE ( const edm::Event& iEvent, const edm::EventSetup& iSetup ) {
