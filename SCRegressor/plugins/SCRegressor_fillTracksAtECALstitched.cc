...
void SCRegressor::branchesTracksAtECALstitched ( TTree* tree, edm::Service<TFileService> &fs ) {
...
void SCRegressor::fillTracksAtECAL_with_EEproj ( int side, int ieta_global_offset, int ieta_signed_offset, int proj ) {
...
void SCRegressor::fillTracksAtECALstitched ( const edm::Event& iEvent, const edm::EventSetup& iSetup, unsigned int proj ) {
