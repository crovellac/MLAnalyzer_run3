...
void SCRegressor::branchesPFCandsAtECALstitched ( TTree* tree, edm::Service<TFileService> &fs ) {
...
void SCRegressor::fillPFCandsAtECALstitched ( const edm::Event& iEvent, const edm::EventSetup& iSetup ) {
