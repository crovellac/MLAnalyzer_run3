...
void SCRegressor::branchesTRKlayersAtECALstitched ( TTree* tree, edm::Service<TFileService> &fs ) {
...
unsigned int SCRegressor::getLayer(const DetId& detid, const TrackerTopology* tTopo) {
 //                                            uint16_t
 // +------------+---------------+---------------------------+-----------------+----------------+
...
void SCRegressor::fillTRKlayersAtECALstitched ( const edm::Event& iEvent, const edm::EventSetup& iSetup, unsigned int proj ) {
