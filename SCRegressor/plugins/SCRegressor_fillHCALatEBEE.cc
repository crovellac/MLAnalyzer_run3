...
void SCRegressor::branchesHCALatEBEE ( TTree* tree, edm::Service<TFileService> &fs ) {
...
void SCRegressor::fillHCALatEBEE ( const edm::Event& iEvent, const edm::EventSetup& iSetup ) {
