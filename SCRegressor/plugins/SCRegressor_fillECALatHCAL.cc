...
void SCRegressor::branchesECALatHCAL ( TTree* tree, edm::Service<TFileService> &fs ) {
...
void SCRegressor::fillECALatHCAL ( const edm::Event& iEvent, const edm::EventSetup& iSetup ) {
